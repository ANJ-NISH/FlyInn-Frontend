...
export const ConfirmPage=()=>
{
    ...
    return (
       ...
       <div className='w-full h-96 p-3 border-[1px] border-gray-300 flex flex-col justify-evenly'>
           <span className='text-md font-medium'>Enter your payment details</span>
           <div className='flex w-full'>
             <div className='flex flex-col mr-5 w-2/5'>
               <label htmlFor="" className='text-sm font-normal mb-1'>Name*</label>
               <input type="text" value={formData.name} onChange={(e)=> setFormData({...formData, name: e.target.value})} className='border-[1px] border-gray-700 p-2 rounded-sm h-9'/>
             </div>
             <div className='flex flex-col w-2/5'>
               <label htmlFor="" className='text-sm font-normal mb-1'>Email*</label>
           ...
           <div className='w-2/5 flex flex-col'>
               <label htmlFor="" className='text-sm font-normal mb-1'>Card number*</label>
               <input type="email" value={formData.cardNumber} maxLength="16"
               onChange={(e)=> setFormData({...formData, cardNumber: e.target.value})}
               className='border-[1px] border-gray-700 p-2 rounded-sm h-9'/>
           </div>
           <div className='w-2/5 flex flex-col'>
               <label htmlFor="" className='text-sm font-normal mb-1'>Expiry*</label>
               <input type="number" value={formData.expiry} placeholder='MM/YY' maxLength="5"
               onChange={(e)=> setFormData({...formData, expiry: e.target.value})}
                className='border-[1px] border-gray-700 p-2 rounded-sm h-9'/>
           </div>
           <div className='w-2/5 flex flex-col'>
               <label htmlFor="" className='text-sm font-normal mb-1'>CVV*</label>
               <input type="number" value={formData.cvv} placeholder='cvv' maxLength="3"
         ...
         <div className='flex justify-end mt-5'>
            ...
            className='h-12 w-44 cursor-pointer rounded-sm text-white text-md font-medium bg-blue-500 px-3 py-2'>Complete Booking {`>`}</button>
         </div>
       </div>
       </div>
        </>
